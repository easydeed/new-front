...
| Document | Purpose | Audience |
|----------|---------|----------|
| [FRONTEND_ARCHITECTURE.md](./FRONTEND_ARCHITECTURE.md) | Next.js frontend architecture, components, and patterns | Frontend Developers |
| [BACKEND_ARCHITECTURE.md](./BACKEND_ARCHITECTURE.md) | FastAPI backend architecture, APIs, and services | Backend Developers |
...
| Document | Purpose | Audience |
|----------|---------|----------|
| [REPOSITORY_STRUCTURE.md](./REPOSITORY_STRUCTURE.md) | Monorepo organization and file structure | All Developers |
...
2. [BACKEND_ARCHITECTURE.md](./BACKEND_ARCHITECTURE.md) - Database layer
3. [SETUP_GUIDE.md](./SETUP_GUIDE.md) - Database initialization
...
### 🔗 Integration Partner
**Focus on these documents:**
1. [INTEGRATION_GUIDE.md](./INTEGRATION_GUIDE.md) - Widget integration
2. [API_REFERENCE.md](./API_REFERENCE.md) - External API endpoints
3. [DEED_GENERATION_GUIDE.md](./DEED_GENERATION_GUIDE.md) - Document generation
...
3. Check [VERCEL_FRONTEND_DEPLOYMENT_GUIDE.md](./VERCEL_FRONTEND_DEPLOYMENT_GUIDE.md) for frontend-specific steps
...
- Request new documentation for uncovered topics
