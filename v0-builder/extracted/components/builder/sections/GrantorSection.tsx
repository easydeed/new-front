...
export function GrantorSection({ value, onChange, suggestedName }: GrantorSectionProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Grantor Name (Current Owner)</label>
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary uppercase"
          />
        </div>
