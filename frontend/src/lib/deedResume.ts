  ...
  const state: DeedBuilderState = {
    ...
    affidavit: meta.affidavit || row.parties
      ? {
          ...
          trustName: meta.affidavit?.trust_name || '',
          settlors: meta.affidavit?.settlors || '',
          trustees: meta.affidavit?.trustees || '',
          revocability: meta.affidavit?.revocability || '',
          revokerName: meta.affidavit?.revoker_name || '',
