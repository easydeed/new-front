    ...
    <section className="section">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-4 flex gap-3">
          <a className="btn-primary inline-flex items-center gap-2 rounded-md px-4 py-2" href="/developers">View API Docs</a>
          <a className="inline-flex items-center gap-2 rounded-md px-4 py-2 ring-1 ring-slate/20 bg-white text-ink hover:bg-slate/10" href="/api-key-request">Get API Key</a>
        </div>
