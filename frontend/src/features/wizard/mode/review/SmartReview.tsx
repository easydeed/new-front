...
export default function SmartReview({ docType, state, onEdit, onConfirm, busy }: Props) {
  ...
  console.log('[SmartReview] docType:', docType);
  
  const handleConfirm = useCallback(() => {
    console.log('[SmartReview] Confirm clicked with state:', state);
  ...
  console.log('[SmartReview] hasAnyData:', hasAnyData, 'hasImportantData:', hasImportantData);
