...
const NAV_ITEMS = [
  { id: 'overview', label: 'Overview', icon: Icons.Dashboard, href: '/admin' },
  { id: 'users', label: 'Users', icon: Icons.Users, href: '/admin?tab=users' },
  { id: 'deeds', label: 'Deeds', icon: Icons.FileText, href: '/admin?tab=deeds' },
